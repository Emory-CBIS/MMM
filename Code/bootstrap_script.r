# --------------------------------------------------------------------
# This is a script to run parametric bootstrap and fit MMM to the bootstrap 
# Data. Fitted Results are saved as output.
# --------------------------------------------------------------------

# --------------------------------------------------------------------
# Load packages and function; Setting parameters in simulation
# --------------------------------------------------------------------
fit.boot.log <- list()
load("./Data/fitsim.RData")
...
#save(fit.boot.log, file=paste("../Data/fitsimboot.RData",sep=""))
